// In-memory singleton cache for the last hash from logs-microservice
...
const hashCache = {
  // Recupera el último hash local (en memoria)
  getLastHash: () => lastHash,
  // Inserta un nuevo hash
  insertHash: (newHash) => {
    lastHash = newHash;
  },
  // Recupera el último hash desde logs-microservice y actualiza el cache
...
// Inicializar cache al arrancar (fetch desde logs-microservice)
